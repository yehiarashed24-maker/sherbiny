  ...
  const layers = [
    {
      ...
      bg: 'linear-gradient(135deg, rgba(236, 72, 153, 0.92) 0%, rgba(217, 70, 239, 0.95) 100%)',
    ...
    },
    {
      ...
      bg: 'linear-gradient(135deg, rgba(14, 165, 233, 0.95) 0%, rgba(56, 189, 248, 0.98) 100%)',
      borderColor: 'rgba(255, 255, 255, 0.6)',
      size: '69%',
      zIndex: 20,
      icon: (
        <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-white drop-shadow" viewBox="0 0 24 24" fill="currentColor">
    ...
    },
    {
      ...
      bg: 'linear-gradient(135deg, rgba(59, 130, 246, 0.95) 0%, rgba(96, 165, 250, 0.98) 100%)',
      borderColor: 'rgba(255, 255, 255, 0.6)',
      size: '52%',
      zIndex: 30,
      icon: (
    ...
    },
    {
      ...
      bg: 'linear-gradient(135deg, rgba(37, 99, 235, 0.96) 0%, rgba(29, 78, 216, 0.98) 100%)',
      borderColor: 'rgba(255, 255, 255, 0.6)',
      size: '36%',
      zIndex: 40,
      icon: (
        <svg className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-white drop-shadow" viewBox="0 0 24 24" fill="currentColor">
    ...
    },
    {
      ...
      bg: 'linear-gradient(135deg, rgba(16, 185, 129, 0.98) 0%, rgba(5, 150, 105, 1) 100%)',
      borderColor: 'rgba(255, 255, 255, 0.65)',
      size: '22%',
      zIndex: 50,
      icon: (
        <svg className="w-2.5 h-2.5 sm:w-3 sm:h-3 text-white drop-shadow" viewBox="0 0 24 24" fill="currentColor">
  ...
  return (
    <div className="flex flex-col items-center gap-4 w-full max-w-xs mx-auto select-none">
      ...
      <div
        ...
        role="region"
        aria-label="Social media interactive card"
      >
