...
const LAWS_DATA = [
  ...
  },
  {
    title: {
      ...
      tr: '2. Bakanlık Kararları', ja: '2. 閣僚令', zh: '2. 部长法令', ko: '2. 장관 법령', es: '2. Decretos Ministeriales', it: '2. Decreti Ministeriali'
    },
    icon: Landmark,
    links: [
      { text: { ar: 'قرارات خاصة بالارباح الراسمالية', en: 'Capital Gains Decrees', fr: 'Décrets sur les Plus-Values', tr: 'Sermaye Kazançları Kararları', ja: 'キャピタルゲイン法令', zh: '资本利得法令', ko: '자본 이득 법령', es: 'Decretos sobre Ganancias de Capital', it: 'Decreti sulle Plusvalenze' }, url: 'https://www.incometax.gov.eg/karar610.asp' },
      { text: { ar: 'قرارات خاصة بالقانون الجديد', en: 'New Law Decrees', fr: 'Décrets d’Application de la Nouvelle Loi', tr: 'Yeni Kanun Uygulama Kararları', ja: '新法令', zh: '新法令', ko: '신규 법령', es: 'Decretos de la Nueva Ley', it: 'Decreti della Nuova Legge' }, url: 'https://www.incometax.gov.eg/karar91.asp' },
      { text: { ar: 'قرارات متنوعة', en: 'Miscellaneous Decrees', fr: 'Décrets Divers', tr: 'Muhtelif Kararlar', ja: 'その他の法令', zh: '杂项法令', ko: '기타 법령', es: 'Decretos Varios', it: 'Decreti Vari' }, url: 'https://www.incometax.gov.eg/karar-new.asp' },
    ]
  },
  {
    title: {
      ...
      tr: '3. Vergi İtiraz Komisyonu Kararları', ja: '3. 租税不服申し立ての原則', zh: '3. 税收上诉原则', ko: '3. 조세 불복 원칙', es: '3. Principios de Apelación Fiscal', it: '3. Principi delle Commissioni di Ricorso'
    },
    icon: Gavel,
    links: [
      { text: { ar: 'الجزء الأول', en: 'Part 1', fr: 'Partie 1', tr: 'Bölüm 1', ja: 'パート1', zh: '第1部分', ko: '1부', es: 'Parte 1', it: 'Parte 1' }, url: 'https://www.incometax.gov.eg/legan.asp' },
      { text: { ar: 'الجزء الثاني', en: 'Part 2', fr: 'Partie 2', tr: 'Bölüm 2', ja: 'パート2', zh: '第2部分', ko: '2부', es: 'Parte 2', it: 'Parte 2' }, url: 'https://www.incometax.gov.eg/legan.asp' },
      { text: { ar: 'الجزء الثالث', en: 'Part 3', fr: 'Partie 3', tr: 'Bölüm 3', ja: 'パート3', zh: '第3部分', ko: '3부', es: 'Parte 3', it: 'Parte 3' }, url: 'https://www.incometax.gov.eg/legan.asp' },
    ]
  },
  {
    title: {
      ...
      tr: '4. Genelgeler ve Yönergeler', ja: '4. 指示と通達', zh: '4. 指示与通告', ko: '4. 지침 및 회람', es: '4. Instrucciones y Circulares', it: '4. Circolari e Istruzioni'
    },
    icon: FileText,
    links: [
      { text: { ar: 'كتب دورية', en: 'Periodic Circulars', fr: 'Circulaires Périodiques', tr: 'Dönemsel Genelgeler', ja: '定期通達', zh: '定期通告', ko: '정기 회람', es: 'Circulares Periódicas', it: 'Circolari Periodiche' }, url: 'https://www.incometax.gov.eg/kdawry.asp' },
      { text: { ar: 'جميع التعليمات التنفيذية لفحص جميع الأنشطة', en: 'Executive Instructions for Examining Activities', fr: 'Instructions Exécutives de Contrôle des Activités', tr: 'Faaliyet İnceleme Uygulama Talimatları', ja: '活動審査に関する執行指示', zh: '关于审查活动的执行指示', ko: '활동 심사에 관한 집행 지침', es: 'Instrucciones Ejecutivas para el Examen de Actividades', it: 'Istruzioni Esecutive per l’Esame delle Attività' }, url: 'https://www.incometax.gov.eg/pand-y.asp' },
      { text: { ar: 'التعليمات التنفيذية للانشطة التي تم عمل اتفاقيات لها', en: 'Executive Instructions for Agreements', fr: 'Instructions Exécutives pour Accords', tr: 'Anlaşmalı Faaliyetler Uygulama Talimatları', ja: '合意に関する執行指示', zh: '关于协议的执行指示', ko: '합의에 관한 집행 지침', es: 'Instrucciones Ejecutivas para Acuerdos', it: 'Istruzioni Esecutive per Accordi' }, url: 'https://www.incometax.gov.eg/btreaties.asp' },
    ]
  }
];
...
const LAWS_UI_TEXT: Record<LangType, { back: string; title: string; subtitle: string }> = {
  ...
  it: {
    ...
    title: 'Biblioteca Giuridica e Fiscale Egiziana',
    subtitle: 'Una raccolta completa di leggi, decreti ministeriali e istruzioni esecutive che regolano le attività finanziarie e fiscali in Egitto.'
  }
};
